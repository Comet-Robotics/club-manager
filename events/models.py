...
class Waiver(models.Model):
    ...
    alternate_for_waiver_id = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="alternate_waivers",
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["robot_combat_events_team_id"],
                name="robot_combat_events_team_id_unique_nulls_not_distinct",
...
class CombatRobot(models.Model):
    ...
    combat_events = models.ManyToManyField(
        ...
        through="CombatEventRegistration",
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["robot_combat_events_robot_id"],
                name="robot_combat_events_robot_id_unique_nulls_not_distinct",
                nulls_distinct=False,
            )
        ]
...
class CombatEventRegistration(models.Model):
    ...
    combat_event = models.ForeignKey(
        CombatEvent,
        on_delete=models.CASCADE,
        related_name="combat_event_registrations",
    )
    combat_robot = models.ForeignKey(
        CombatRobot,
        on_delete=models.CASCADE,
        related_name="combat_event_registrations",
    )
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(
                fields=["combat_event", "combat_robot"],
                name="combat_event_registrations_combat_event_combat_robot_unique",
            )
        ]
