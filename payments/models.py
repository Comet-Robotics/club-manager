...
class Payment(ComputedFieldsModel):
    ...
    class Method(models.TextChoices):
        ...
        paypal = (
            "paypal",
            _("PayPal Payment (LEGACY - DO NOT USE FOR NEW PAYMENTS)"),
        )
        venmo = (
            "venmo",
            _("Venmo Payment (LEGACY - DO NOT USE FOR NEW PAYMENTS)"),
        )
        cashapp = (
            "cashapp",
            _("Cash App Payment (LEGACY - DO NOT USE FOR NEW PAYMENTS)"),
        )
    ...
    @computed(
        models.BooleanField(),
        depends=[("self", ["verified_by", "completed_at"])],
    )
